...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_seq_length_test", type=str, default=128, help="max_seq_length")
    ...
    "--do_eval=false " \
    "--do_predict=true " \
    "--data_dir=DeepCT2/data/docs.training.small.tsv " \
    ...
    "--output_dir="+args.predictions_dir_test+ "pos_doc_main " 
    ...
    "--num_train_epochs=" + args.num_train_epochs +" " \
    "--gpu_device=" + args.gpu_device + " " \
    "--output_dir="+args.predictions_dir_test+ "neg_doc_main " 

    os.system(cmd2)


    # The `years` list in the provided Python script contains strings representing different years.
    # These years are used in a loop to generate commands for running a script multiple times, each
    # time with a different year value. The loop iterates over each year in the `years` list and
    # generates commands for processing data specific to that year.
    ...
    for year in years:
        ...
        cmd1 = "python DeepCT2/run_deepct.py " \
            ...
            "--do_eval=false " \
            "--do_predict=true " \
            "--data_dir=DeepCT2/data/docs."+ year+ ".tsv " \
            "--vocab_file=DeepCT2/uncased_L-12_H-768_A-12/vocab.txt " \
            "--bert_config_file=DeepCT2/uncased_L-12_H-768_A-12/bert_config.json " \
            "--init_checkpoint=" + int_checkpoint_pos + " " \
            "--max_seq_length=" + args.max_seq_length_test + " " \
            ...
            "--num_train_epochs=" + args.num_train_epochs +" " \
            "--gpu_device=" + args.gpu_device + " " \
            "--output_dir="+args.predictions_dir_test+ "pos_doc" + year + " " 
        ...
        cmd2 = "python DeepCT2/run_deepct.py " \
            ...
            "--num_train_epochs=" + args.num_train_epochs +" " \
            "--gpu_device=" + args.gpu_device + " " \
            "--output_dir="+args.predictions_dir_test+ "neg_doc"  + year + " " 
